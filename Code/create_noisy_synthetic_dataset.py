...
if __name__ == '__main__':
   ...
   print size
   randindices = np.random.randint(0,Idx_R1[0].shape[0],size)
   ...
   print size
   randindices = np.random.randint(0,Idx_R2[0].shape[0],size)
   for i in randindices:
       alldata[i][4]=0
   ...
   print size
   randindices = np.random.randint(0,Idx_R3[0].shape[0],size)
   for i in randindices:
       alldata[i][4]=0
